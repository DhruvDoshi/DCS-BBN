...
verifies transaction and transactions and also verifies the whole blockchain
and also privides the proof of the work
"""


#here we have imported methods from hash_util and wallet and worked on them
